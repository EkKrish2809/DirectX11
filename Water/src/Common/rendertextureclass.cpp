...
void RenderTextureClass::SetRenderTarget(ID3D11DeviceContext* deviceContext)
{
	...
	// deviceContext->OMSetRenderTargets(1, &pID3D11RenderTargetView, gpID3D11DepthStencilView);
...
void RenderTextureClass::ClearRenderTarget(ID3D11DeviceContext* deviceContext, float red, float green, float blue, float alpha)
{
	...
	// deviceContext->ClearRenderTargetView(pID3D11RenderTargetView, color);
    
	// Clear the depth buffer.
	deviceContext->ClearDepthStencilView(m_depthStencilView, D3D11_CLEAR_DEPTH, 1.0f, 0);
	// deviceContext->ClearDepthStencilView(gpID3D11DepthStencilView, D3D11_CLEAR_DEPTH, 1.0f, 0);
