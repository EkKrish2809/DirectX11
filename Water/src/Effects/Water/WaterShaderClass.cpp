...
bool WaterShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"./src/Shaders/Water/water.vs", L"./src/Shaders/Water/water.ps");
	if(!result)
	{
		return false;
	}
...
bool WaterShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix, 
			      DirectX::XMMATRIX projectionMatrix, DirectX::XMMATRIX reflectionMatrix, ID3D11ShaderResourceView* refractionTexture, 
			      ID3D11ShaderResourceView* reflectionTexture, ID3D11ShaderResourceView* normalTexture, DirectX::XMFLOAT3 cameraPosition, 
			      DirectX::XMFLOAT2 normalMapTiling, float waterTranslation, float reflectRefractScale, DirectX::XMVECTOR refractionTint, 
			      DirectX::XMFLOAT3 lightDirection, float specularShininess)
{
	bool result;
...
bool WaterShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix, DirectX::XMMATRIX projectionMatrix,
					   DirectX::XMMATRIX reflectionMatrix, ID3D11ShaderResourceView* refractionTexture, 
					   ID3D11ShaderResourceView* reflectionTexture, ID3D11ShaderResourceView* normalTexture, 
					   DirectX::XMFLOAT3 cameraPosition, DirectX::XMFLOAT2 normalMapTiling, float waterTranslation, float reflectRefractScale, 
					   DirectX::XMVECTOR refractionTint, DirectX::XMFLOAT3 lightDirection, float specularShininess)
{
	HRESULT result;
	...
	dataPtr2->padding2 = DirectX::XMFLOAT2(0.0f, 0.0f);
